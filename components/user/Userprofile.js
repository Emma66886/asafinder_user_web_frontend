...
import { Box, Heading, Grid, GridItem, MenuItem, Text } from "@chakra-ui/react";
    ...
    <Box bg="#0D0E12" color="#fff" w={"100vw"} overflowY="hidden">
      ...
      >
        <GridItem colSpan="2">
          ...
          >
            <GridItem rowSpan="2" w="max-content" colSpan="1">
              <Image
                height="74px"
                width="74px"
            ...
            <GridItem rowSpan="1" w="max-content" colSpan="2" color="#848484">
              UNIQUE ID: {userId}
            </GridItem>
          </Grid>
        </GridItem>
        ...
        <GridItem
          ...
          bg="#111621"
          borderRadius="4px"
          _hover={{ color: "#000", bg: "#fff", cursor: "pointer" }}
        >
          <Link href="/listnewtoken">Submit Token</Link>
        </GridItem>
        <GridItem
          colSpan="2"
          placeItems="center"
        ...
        <GridItem
          ...
          borderRadius="4px"
        >
          <Link href="/accountsubscription"> Account Subsciption</Link>
        </GridItem>
        <GridItem
          colSpan="2"
          placeItems="center"
